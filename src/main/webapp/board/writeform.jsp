...
<body>
	<div class="container">
		...
		<div class="contents">
			<form action="MyProjectBoard.do?cmd=writeOk" method="post" enctype="multipart/form-data">
				<table class="table">
					<tr>
						<th>작성자</th>
						<td><div class="input-group mb-3">
					  			<input type="text" class="form-control" aria-label="Username" 
					  									aria-describedby="basic-addon1" placehorder="작성자" name = "writer" value="${myinfo.name }" readonly>
							</div>
						</td>
					</tr>
					<tr>
