        ...
        <input type="hidden" name="eno" value="${logindto.eno }" />
            <table class="table">
                    ...
                    <td>
                        <select class="inputTag" name="roomno">
                            <c:forEach var="vo" items="${list }">
	                            <c:choose>
	                            	<c:when test="${dto.roomNo eq vo.roomNo}">
	                            		<option value="${vo.roomNo }" selected="selected">${vo.roomName }</option>
	                            	</c:when>
	                            	<c:otherwise>
                ...
                <tr>
                    <th>예약 일자</th>
                    <td>
                        <input class="inputTag" type="date" name="rezDate" value="${dto.rezDate }">
                    </td>
                </tr>
                <tr>
                    <th>시작시간</th>
                    <td>
                        <select class="inputTag" name="startTime" id="time1">
                        	<c:forEach var="i" begin="9" end="20" step="1">
                        		<c:choose>
                        			<c:when test="${dto.startTime eq i }">
