...
<div class="container">
	<form action="MyProjectCalendar.do?cmd=addCalOk" method="post">
		...
		<table class="table">
			<tr>
				<th>일정명</th>
				<td><input class="inputTag" type="text" name="title" id="" /></td>
			</tr>
			<tr>
				<th>StartDate</th>
				<td><input class="inputTag" type="date" name="startdate" id="" /></td>
			</tr>
			<tr>
				<th>EndDate</th>
				<td><input class="inputTag" type="date" name="enddate" id="" /></td>
			</tr>
			<tr>
				<th>위치</th>
				<td><input class="inputTag" type="text" name="loc" id="" /></td>
			</tr>
			<tr>
				<th>Memo</th>
				<td><input class="inputTag memo" type="text" name="contents" id="" /></td>
			</tr>
			<tr>
				<th>종류</th>
				<td>
			...
			<tr>
				<td colspan="2" style="text-align: right;">
					<input type="button" class="btn btn-success" value="일정 추가" />			
				</td>
			</tr>
		</table>
		</form>
